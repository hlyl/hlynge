@echo off
echo Now I am in the launchserver.bat
...
for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg AdditionalMPMods') do (
    set mods=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg Port') do (
    set port=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg ServerPassword') do (
    set password=%%a
)
...
for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg ServerConfig') do (
    set serverConfig=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg MPMission') do (
    set mission=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg ClientEXE') do (
    set clientEXE=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg ServerEXE') do (
    set serverEXE=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg ClientLaunchParams') do (
    set clientLaunchParams=%%a
)

for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg ServerLaunchParams') do (
