...
for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg SPMission') do (
    set mission=%%a
)
...
for /f "delims=" %%a in ('call ExtractData.bat ../../%modPath%/project.cfg ../../user.cfg PlayerName') do (
    set playerName=%%a
)
